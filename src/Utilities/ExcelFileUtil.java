...
public class ExcelFileUtil 
{
	...
	{
		FileInputStream fi = new FileInputStream("D:\\rkmohan\\Rkmohan_Sln_FW\\ERP_Stock\\TestInput\\InputSheet.xlsx");
	...
	public void setCellData(String sheetname,int row,int column,String status) throws Throwable
	{
		...
		FileOutputStream fo = new FileOutputStream("D:\\rkmohan\\Rkmohan_Sln_FW\\ERP_Stock\\TestOutput\\hybrid.xlsx");
		wb.write(fo);
		fo.close();
	}
}
